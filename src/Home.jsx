  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            ...
            <div className="flex items-center">
              <div className="w-12 h-12 bg-gradient-to-br from-gray-800 to-gray-600 rounded-full"></div>
            </div>
            ...
            <nav className="hidden md:flex space-x-8">
              ...
              <a href="#resume" className="text-gray-900 hover:text-gray-600 font-medium">Resume</a>
            </nav>
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
        <div className="text-left">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-4">
            I'm Sreerag — <span className="text-gray-500">a digital<br />product designer</span>
          </h1>
        </div>
      </section>

      {/* Works Section */}
      <section id="work" className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-2">Works</h2>
          <p className="text-gray-600">Personal & Freelancing</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="space-y-4">
            <p className="text-gray-700 leading-relaxed">
              I am from Kerala, graduated in computer Application from Bharathiyar University. Started in IT support, transitioned into SaaS engineering, and discovered a passion for UI/UX design after redesigning a full SaaS interface.
            </p>
            <p className="text-gray-700 leading-relaxed">
              I'm committed to continuous learning and enjoy crafting clean, user-focused designs that contribute to meaningful product experiences.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <h2 className="text-2xl font-bold text-gray-900 mb-12">Work Experience</h2>
      ...
      <section id="contact" className="bg-pink-50 py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">
            Want to create something<br />Lovable? Drop me an email.
          </h2>
